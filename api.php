...
switch ($t) {
    case 'topic1':
        $url = 'https://favorite-subject.tak17poljakov.itmajakas.ee/';
    ...
    case 'topic3':
        ...
        break;
    default:
        $url = 'https://favorite-subject.tak17poljakov.itmajakas.ee?limit=3';
...
<div class="container">
    <div align="right">
        <a href="https://favorite-subject.tak17poljakov.itmajakas.ee/">API</a>
        <a>│</a>
        <a href="https://favorite-subject.tak17poljakov.itmajakas.ee/form.php">Form</a>
    </div>
    <div class="col-4">
        <ul>
